...
For timing, I prefer to use the program LosslessCut, because it's free, open source, has precise measurements, is easy to use, and is also a useful tool. To download it, navigate [here](https://github.com/mifi/lossless-cut/releases), look under "Assets", and click on the one that reads "LosslessCut-win-x64.7z". Extract into a folder of your choice.
